...
using Love2Match.Resources;
using System.Collections.ObjectModel;
using System.IO.IsolatedStorage;

using Love2Match.Utils;
...
namespace Love2Match.Views
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        {
            MainViewModel.Couple[0] = new Lover();
            MainViewModel.Couple[1] = new Lover();
            Lover1TexBox.Text = String.Empty;
            Lover2TexBox.Text = String.Empty;
        }
